...
- `/share-implementation-plan`, `/agent-handoff-document`, `/share-architecture-diagram` - walkthroughs with example documents (`content/examples/*.md`, served at `/examples/<slug>/raw`)
